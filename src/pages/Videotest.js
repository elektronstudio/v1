export default {
  ...
  <div class="layout-videotest">
    ...
    <div><audience-openvidu id="test" /><p><br/>WebRTC based solution on OpenVidu server. Minimal initial lag, 12fps updates, limited number of participants. Has audio support.</p></div>
  </div>
  `,
};
