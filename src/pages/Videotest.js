...
export default {
  ...
  <div class="layout-videotest">
    ...
    <div><video-audience-images /><p><br/>Sending still video frames via Websocket and broadcasting it to other clients. Small initial lag, 1s update lag, medium number of participants. No audio support.</p></div>
